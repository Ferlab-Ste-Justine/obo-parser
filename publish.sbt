...
ThisBuild / scmInfo := Some(
  ScmInfo(
    ...
    "scm:git@github.com:Ferlab-Ste-Justine/obo-parser.git"
  )
)
...
ThisBuild / sonatypeProjectHosting := Some(GitHubHosting("Ferlab Ste-Justine", "obo-parser", "apaul@ferlab.bio"))
